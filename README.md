...
[![GitHub release](https://img.shields.io/github/v/release/S1mvolxD/Windows-Temp-Cleaner)](https://github.com/S1mvolxD/ваш-репозиторий/releases)
[![GitHub issues](https://img.shields.io/github/issues/S1mvolxD/Windows-Temp-Cleaner)](https://github.com/S1mvolxD/ваш-репозиторий/issues)
...
# 🚀 Quick start
```ps1
irm https://raw.githubusercontent.com/S1mvolxD/Windows-Temp-Cleaner/refs/heads/main/Clear-AllTemp.ps1 | iex
```
